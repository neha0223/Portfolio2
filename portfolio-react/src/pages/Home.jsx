          ...
          <section id="home">
            <div className="about-container">
              ...
              <div className="info">
                ...
                <div className="dropdown">
                  ...
                  <div className="dropdown-content">
                    <ul>
                      ...
                      <li><a href="unity.html">Unity + XR Interaction Toolkit</a></li>
                      <li>Unreal</li>
                      <li>Maya</li>
                      <li>VRED Pro</li>
                      <li>Keyshot</li>
                ...
                <div className="dropdown">
                  ...
                  <div className="dropdown-content">
                    <ul>
                      ...
                      <li><a href="poster.html">Adobe Photoshop</a></li>
                      <li><a href="poster.html">Adobe Illustrator</a></li>
                      <li>Adobe InDesign</li>
                      <li>Adobe XD</li>
                      <li>Sketch</li>
                      <li><a href="spotify.html">Android Studio</a></li>
                      <li>Canva</li>
                      <li>Procreate</li>
                    </ul>
                  </div>
                ...
                <div className="dropdown">
                  <h3>
                    video production <span className="caret">▼</span>
                  </h3>
                  <div className="dropdown-content">
                    <ul>
                      <li><a href="premiere.html">Adobe Premiere Pro</a></li>
                ...
                <div className="dropdown">
                  <h3>
                    web technologies <span className="caret">▼</span>
                  </h3>
                  <div className="dropdown-content">
                    <ul>
                      <li><a href="cs.html">C#</a></li>
                      <li><a href="mystery.html">C</a></li>
                      <li>C++</li>
                      <li><a href="spotify.html">Java</a></li>
                      <li><a href="VIP.html">Python</a></li>
                ...
                <div className="dropdown">
                  <h3>
                    productivity <span className="caret">▼</span>
                  </h3>
                  <div className="dropdown-content">
                    <ul>
              ...
              <div className="photo">
                <img
                  src="/assets/images/Neha_picture.jpg"
                  alt="A photo of Neha"
                />
